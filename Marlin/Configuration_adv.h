...
#define SHOW_TEMP_ADC_VALUES    //MODI TEMP TABLE
 ...
 */
#define USE_CONTROLLER_FAN    //MODI
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PD12           // Set a custom pin for the controller fan  //MODI
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first  //MODI
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 //MODI bf 300
   ...
   */
  #define BLTOUCH_HS_MODE true //MODI
 ...
 */
#define Z_STEPPER_AUTO_ALIGN    //MODI
 ...
 */
//#define INPUT_SHAPING_X   //MODI  
//#define INPUT_SHAPING_Y   //MODI
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32  //8 MODI TEST
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 64  //16 MODI TEST
#else
  #define BLOCK_BUFFER_SIZE 64  //16 MODI TEST
#endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE  //MODI
 ...
 * @section tmc/config
 */
#if HAS_TRINAMIC_CONFIG || HAS_TMC26X  //MODI
  ...
  #define CHOPPER_TIMING_X  CHOPPER_09STEP_24V        // For X Axes (override below)  //MODI
 ...
 */
#define HOST_ACTION_COMMANDS    //MODI
