...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_OCTOPUS_PRO_V1_0  //MODI
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1  //MODI
#define BAUDRATE 57600  //MODI
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_3 1     //MODI
#define BAUDRATE_3 115200   //MODI   
...
#define  CUSTOM_MACHINE_NAME "CORE M&C 2.1.3" //MODI
 ...
 */
#define X_DRIVER_TYPE  TMC2209  //MODI
#define Y_DRIVER_TYPE  TMC2209  //MODI
#define Z_DRIVER_TYPE  TMC2209  //MODI
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209  //MODI
...
#define E0_DRIVER_TYPE TMC2209  //MODI
...
#define HEATER_0_MINTEMP   0  //MODI
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //MODI
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //MODI
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 40, 100 } //MODI TEST OK
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3500, 3500, 100, 10000 } //MODI TEST OK
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //MODI


// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //MODI
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -5, -1.80} //MODI
...
#define XY_PROBE_FEEDRATE (133*60)  //MODI 

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (20*60)  //MODI
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // Z Clearance between probe points //MODI
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  //MODI TEST OK
...
#define INVERT_X_DIR false  //MODI
#define INVERT_Y_DIR false  //MODI
#define INVERT_Z_DIR false  //MODI
...
#define INVERT_E0_DIR true  //MODI
...
#define HOME_AFTER_DEACTIVATE   // Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety. //MODI
...
#define X_BED_SIZE 290  //MODI
#define Y_BED_SIZE 230  //MODI
...
#define AUTO_BED_LEVELING_BILINEAR    //MODI
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  //MODI OK
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4 //MODI
...
#define MANUAL_X_HOME_POS 4 //MODI
...
#define HOMING_FEEDRATE_MM_M { (75*50), (75*50), (10*40) } //MODI
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501  //MODI TEST OK
...
//
#define PREHEAT_1_LABEL       "PLA"   //MODI
#define PREHEAT_1_TEMP_HOTEND 210
#define PREHEAT_1_TEMP_BED     50
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG"  //MODI
 ...
 */
#define NOZZLE_PARK_FEATURE //MODI
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //MODI
